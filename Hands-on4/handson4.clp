...
(deffacts credit_card
   ...
   (credit_card (id 2) (number "2345-6789-0123-4567") (holder "Oscar Martinez") (bank "Banorte") (group "Mastercard"))
   ...
   (credit_card (id 6) (number "6789-0123-4567-8901") (holder "Andy Bernard") (bank "Banorte") (group "Mastercard"))
   ...
   (credit_card (id 10) (number "0123-4567-8901-2345") (holder "Creed") (bank "Banorte") (group "Mastercard"))
)
...
(defrule Banorte
    (client (name ?name))
    (order (client-name ?name) (client-id ?id) (payment-method "card"))
    (credit-card (holder ?name) (bank "Banorte"))
    =>
    (printout t ?name " for buying with Banorte your first payment will be in 3 months on your next purchase" crlf)
    (assert (voucher (code "BANORTE") (holder ?name) (description "INITIAL PAYMENT IN 3 MONTHS")))
)
;18
(defrule hsbc
    (client (name ?name))
